...
class UserService:
    ...
    def search_users(
        ...
        return (
            User.objects.filter(username_normalized__istartswith=query)
            .exclude(is_active=False)
            .order_by("username_normalized")[offset : offset + limit]
        )

    @staticmethod
    @transaction.atomic
    def create_user(
        *, username: str, email: str, password: str, role: str = UserRole.CLIENT
    ) -> User:
